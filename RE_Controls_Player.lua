...
local function onFrame(dt)
	...
	if I.UI.getMode()=="Interface" then
		...
		if InventoryItemSelected[1] and TurnLeft(-0.2)==true and InventoryItemSelected[2]==nil and InventoryItemSelected[1]~=1 and MenuSelectStop==false then
			InventoryItemSelected[1]=InventoryItemSelected[1]-1
			MenuSelectStop=true 
			ui.showMessage(tostring(InventoryItems[InventoryItemSelected[1]]))
		elseif InventoryItemSelected[1] and  TurnRight(0.2)==true and InventoryItemSelected[2]==nil and InventoryItemSelected[1]~=types.NPC.getCapacity(self) and MenuSelectStop==false  then
			InventoryItemSelected[1]=InventoryItemSelected[1]+1
			MenuSelectStop=true 
			ui.showMessage(tostring(InventoryItems[InventoryItemSelected[1]]))
		elseif InventoryItemSelected[1] and  MoveBackward(0.2)==true and InventoryItemSelected[2]==nil and InventoryItemSelected[1]<=(types.NPC.getCapacity(self)-2) and MenuSelectStop==false   then
			InventoryItemSelected[1]=InventoryItemSelected[1]+2
			MenuSelectStop=true 
			ui.showMessage(tostring(InventoryItems[InventoryItemSelected[1]]))
		elseif InventoryItemSelected[1] and  MoveForward(-0.2)==true and InventoryItemSelected[2]==nil  and InventoryItemSelected[1]>=3 and MenuSelectStop==false  then
			InventoryItemSelected[1]=InventoryItemSelected[1]-2
			MenuSelectStop=true 
			ui.showMessage(tostring(InventoryItems[InventoryItemSelected[1]]))
		elseif InventoryItemSelected[1] and InventoryItemSelected[2]==nil and input.isActionPressed(input.ACTION.Use)==true and ToggleUseButton==true then
			print("here")
